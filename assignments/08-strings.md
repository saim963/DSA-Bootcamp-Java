...
- [Defanging an Ip address](https://leetcode.com/problems/defanging-an-ip-address/)  Solved
- [Shuffle String](https://leetcode.com/problems/shuffle-string/)  Solved
- [Goal Parser Interpretation](https://leetcode.com/problems/goal-parser-interpretation/)  Solved
- [Count Items Matching a rule](https://leetcode.com/problems/count-items-matching-a-rule/)  Solved
- [Sorting the Sentence](https://leetcode.com/problems/sorting-the-sentence/)
- [Check if two strings are equivalent](https://leetcode.com/problems/check-if-two-string-arrays-are-equivalent/)
- [To Lower Case](https://leetcode.com/problems/to-lower-case/)  Solved
...
- [Roman to Integer](https://leetcode.com/problems/roman-to-integer/)  Solved
